...
namespace ZeroDbs.Interfaces
{
    ...
    {
        ZeroDbs.Interfaces.IDbCommand GetDbCommand<T>() where T : class, new();
        ZeroDbs.Interfaces.IDbTransactionScope GetDbTransactionScope<T>(System.Data.IsolationLevel level, string identification = "", string groupId = "") where T : class, new();
        ZeroDbs.Interfaces.IDbTransactionScopeCollection GetDbTransactionScopeCollection();
