...
namespace MyDbs.TestDb
{
    ...
    /// </summary>
    [Serializable]
    public partial class tQ_CARWEIGHT120T
    {
        ...
        private string _FS_SENDERNAME;
        /// <summary>
        /// 发货方名称(来自IT_SUPPLIER表)
        /// </summary>
        public string FS_SENDERNAME
        {
            get { return _FS_SENDERNAME; }
            set { _FS_SENDERNAME = value; }
        }
        ...
        private string _FS_TRANSERNAME;
        /// <summary>
        /// 承运方名称(来自IT_TRANS表)
        /// </summary>
        public string FS_TRANSERNAME
        {
            get { return _FS_TRANSERNAME; }
            set { _FS_TRANSERNAME = value; }
        }
        ...
        private string _FS_RECEIVERNAME;
        /// <summary>
        /// 收货方名称(来自IT_STORE表)
        /// </summary>
        public string FS_RECEIVERNAME
        {
            get { return _FS_RECEIVERNAME; }
            set { _FS_RECEIVERNAME = value; }
        }
        ...
        private string _FS_FLOWNAME;
        /// <summary>
        /// 流向名称(来自BT_WEIGHTTYPE表)
        /// </summary>
        public string FS_FLOWNAME
        {
            get { return _FS_FLOWNAME; }
            set { _FS_FLOWNAME = value; }
        }
