...
namespace  Huanr.NativeSoilWebApp.Tools.AlipayDirect
{
    ...
    public class Notify
    {
        ...
        public Notify(ZeroDbs.Interfaces.IDbService zeroService, Microsoft.AspNetCore.Http.IHttpContextAccessor httpContextAccessor)
        {
            if (_Config == null)
            {
                _Config = new Config(zeroService, httpContextAccessor);
            }
